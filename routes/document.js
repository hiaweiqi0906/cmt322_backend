...
router.get('/all', requireAuth, requireAdmin, documentController.listDoc) // get list of documents
...
router.put('/', requireAuth, requireLawyerAndAdmin, documentController.updateDoc) // edit selected document
